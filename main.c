...
unsigned int degree_to_period[] = { 2621, 2609, 2598, 2586, 2574, 2563, 2551, 2539, 2528, 2516,
                                    2504, 2493, 2481, 2470, 2458, 2446, 2435, 2423, 2411, 2400,
                                    2388, 2376, 2365, 2353, 2341, 2330, 2318, 2306, 2295, 2283,
                                    2272, 2260, 2248, 2237, 2225, 2213, 2202, 2190, 2178, 2167,
                                    2155, 2143, 2132, 2120, 2108, 2097, 2085, 2073, 2062, 2050,
                                    2038, 2027, 2015, 2004, 1992, 1980, 1969, 1957, 1945, 1934,
                                    1922, 1910, 1899, 1887, 1875, 1864, 1852, 1840, 1829, 1817,
                                    1806, 1794, 1782, 1771, 1759, 1747, 1736, 1724, 1712, 1701,
                                    1689, 1677, 1666, 1654, 1642, 1631, 1619, 1607, 1596, 1584,
                                    1572, 1561, 1549, 1538, 1526, 1514, 1503, 1491, 1479, 1468,
                                    1456, 1444, 1433, 1421, 1409, 1398, 1386, 1374, 1363, 1351,
                                    1340, 1328, 1316, 1305, 1293, 1281, 1270, 1258, 1246, 1235,
                                    1223, 1211, 1200, 1188, 1176, 1165, 1153, 1141, 1130, 1118,
                                    1106, 1095, 1083, 1072, 1060, 1048, 1037, 1025, 1013, 1002,
                                    990, 978, 967, 955, 943, 932, 920, 908, 897, 885,
                                    874, 862, 850, 839, 827, 815, 804, 792, 780, 769,
                                    757, 745, 734, 722, 710, 699, 687, 675, 664, 652,
                                    640, 629, 617, 606, 594, 582, 571, 559, 547, 536,
                                    524};
...
void write_joyst_uart(char address, int avg_int, float avg_flt,
                      float max, float min);
...
int main(void)
{
    ...
    while (TRUE)
    {
        ...
        if(chanel==1){
            ...
            write_joyst_uart(address, media_x, volt_x,
                             max_x, min_x);
        ...
        if(chanel==2){
            ...
            write_joyst_uart(address, media_y, volt_y,
                             max_y, min_y);
